...
+`::
IfWinNotExist, ahk_class ahk_class MozillaWindowClass
	Run, firefox.exe
if WinActive("ahk_class ahk_class MozillaWindowClass")
{
	Send ^{tab}^{tab}
}
else
	WinActivate ahk_class ahk_class MozillaWindowClass
Return
...
!+`::
;==================Not Commonly used script for Google Chrome=======================
